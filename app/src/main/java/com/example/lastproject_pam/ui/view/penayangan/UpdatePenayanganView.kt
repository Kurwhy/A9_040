...
object DestinasiUpdatePnygn: DestinasiNavigasi {
...
fun UpdateScreenPenayangan(
    ...
    Scaffold (
        ...
        topBar = {
            CoustumeTopAppBar(
                title = DestinasiUpdatePnygn.titleRes,
